...
import { ArrowLeft, Clock, GitPullRequest } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div>
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-widest text-neutral-600">{review.repositoryFullName}</span>
        </div>
